    ...
    NavHost(
        ...
        composable(Routes.ADMIN_DASHBOARD) {
            AdminDashboardScreen(
                ...
                onSeeAllActivities = {
                    navController.navigate(Routes.ADMIN_ACTIVITIES)
                }
            )
        }
        ...
        composable(Routes.ADMIN_ACTIVITIES) {
        ...
        composable(
            ...
            StudentSubmittedApplicationDetailScreen(
                ...
                onMessagesClick = { selectedApplicationId, chatType ->
                    Log.d(
                        "ChatNavigation",
                        "Navigate chat applicationId=$selectedApplicationId chatType=$chatType"
                    )
                    navController.navigate(
        ...
        composable(
            ...
            Log.d(
                "ChatDebug",
                "Route chat applicationId=$applicationId, name=$name, offer=$offerTitle, chatType=$chatType"
            )
