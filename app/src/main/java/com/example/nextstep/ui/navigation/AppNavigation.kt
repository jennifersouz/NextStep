...
fun AppNavigation() {
    ...
    NavHost(
        ...
        composable(Routes.STUDENT_DASHBOARD) {
            StudentDashboardScreen(
                ...
                onCompanyClick = { companyId ->
                    Log.d(
                        "CompanyProfileDebug",
                        "Navegando do Detalhe da Oferta. ID enviado: $companyId"
                    )
                    navController.navigate(
        ...
        composable(
            ...
            StudentInternshipDetailScreen(
                ...
                onAdvisorProfileClick = { profileId ->
                    Log.d(
                        "ProfileClick",
                        "Navegando advisor profileId=$profileId type=advisor"
                    )
                    navController.navigate(
                        Routes.profileDetail(profileId, "advisor")
                    )
                },
                onTeacherProfileClick = { profileId ->
                    Log.d(
                        "ProfileClick",
                        "Navegando teacher profileId=$profileId type=teacher"
                    )
                    navController.navigate(
                        Routes.profileDetail(profileId, "teacher")
                    )
                }
            )
        }
        ...
        composable(
            ...
            arguments = listOf(
                navArgument(Routes.PROFILE_DETAIL_PROFILE_ID_ARG) {
                    type = NavType.StringType
                },
                navArgument(Routes.PROFILE_DETAIL_TYPE_ARG) {
                    type = NavType.StringType
                }
            )
        ) { backStackEntry ->
            ...
            Log.d(
                "ProfileClick",
                "Route aberta profileId=$profileId type=$type"
            )
        ...
        composable(
            ...
            AdvisorStudentDetailScreen(
                ...
                onEvaluateClick = {
                    Log.d(
                        "AdvisorNavigation",
                        "Avaliação do orientador ainda não tem rota ativa. applicationId=$applicationId"
                    )
                }
            )
        }
        ...
        composable(
            ...
            arguments = listOf(
                navArgument(Routes.TEACHER_STUDENT_DETAIL_APP_ID_ARG) {
                    type = NavType.StringType
                },
                navArgument(Routes.TEACHER_STUDENT_DETAIL_PROFILE_ID_ARG) {
                    type = NavType.StringType
                },
                navArgument(Routes.TEACHER_STUDENT_DETAIL_NAME_ARG) {
                    type = NavType.StringType
                },
                navArgument(Routes.TEACHER_STUDENT_DETAIL_OFFER_ARG) {
                    type = NavType.StringType
                },
                navArgument(Routes.TEACHER_STUDENT_DETAIL_COMPANY_ARG) {
                    type = NavType.StringType
                },
                navArgument(Routes.TEACHER_STUDENT_DETAIL_STATUS_ARG) {
                    type = NavType.StringType
                }
            )
        ) { backStackEntry ->
            val applicationId = backStackEntry.arguments
                ?.getString(Routes.TEACHER_STUDENT_DETAIL_APP_ID_ARG)
                .orEmpty()

            val studentProfileId = backStackEntry.arguments
                ?.getString(Routes.TEACHER_STUDENT_DETAIL_PROFILE_ID_ARG)
                .orEmpty()

            val studentName = Uri.decode(
                backStackEntry.arguments
                    ?.getString(Routes.TEACHER_STUDENT_DETAIL_NAME_ARG)
                    .orEmpty()
            )

            val offerTitle = Uri.decode(
                backStackEntry.arguments
                    ?.getString(Routes.TEACHER_STUDENT_DETAIL_OFFER_ARG)
                    .orEmpty()
            )

            val companyName = Uri.decode(
                backStackEntry.arguments
                    ?.getString(Routes.TEACHER_STUDENT_DETAIL_COMPANY_ARG)
                    .orEmpty()
            )

            val status = Uri.decode(
                backStackEntry.arguments
                    ?.getString(Routes.TEACHER_STUDENT_DETAIL_STATUS_ARG)
                    .orEmpty()
            )
        ...
        composable(
            ...
            StudentSubmittedApplicationDetailScreen(
                ...
                onMessagesClick = { selectedApplicationId ->
                    Log.d(
                        "ChatNavigation",
                        "Navigate chat applicationId=$selectedApplicationId"
                    )
                    navController.navigate(
        ...
        composable(
            ...
            Log.d(
                "ChatDebug",
                "Route chat applicationId=$applicationId, name=$name, offer=$offerTitle"
            )
        ...
        composable(
            route = Routes.COMPANY_INTERN_STUDENT_PROFILE,
            arguments = listOf(
                navArgument(Routes.COMPANY_INTERN_STUDENT_PROFILE_ARG) {
                    type = NavType.StringType
                }
            )
        ) { backStackEntry ->
            val applicationId = backStackEntry.arguments
                ?.getString(Routes.COMPANY_INTERN_STUDENT_PROFILE_ARG)
                .orEmpty()
